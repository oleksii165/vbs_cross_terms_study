...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      std::string jsonfilestr =  txt_dir + "Wmy_lvy_cuts.json"; 
      std::cout << "++++++assume .json for this Wmy_lvy" << "is " << jsonfilestr << "\n";
      ...
      std::ifstream ana_hist_file(txt_dir + "/Wmy_lvy_hists.json");      
      ...
      if (_docut==1){
        std::vector<std::string> pic_particles = {"tagjet1", "tagjet2", "MET", "lepton", "photon"};
