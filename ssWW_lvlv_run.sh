...
####SR
#ssWW sample
python run_chain_all_rivets.py --tGenProd "WmWm" --tGenDec "lvlv" --runINT 1 --runQUAD 1 --runCROSS 1 --runLocally 0 --routine "ssWW_lvlv" --cut "SR" --runRivet $run_1_download_0
python run_chain_all_rivets.py --tGenProd "WpWp" --tGenDec "lvlv" --runINT 1 --runQUAD 1 --runCROSS 1 --runLocally 0 --routine "ssWW_lvlv" --cut "SR" --runRivet $run_1_download_0
##WZ sample
